...
function ApplyForm() {
  ...
  const onSubmit = (event) => {
    ...
    if (!data.repoURL) {
      data.repoURL = 'https://www.github.com/spader/docsearch';
    }
    ...
    <Card className="uil-m-auto apply-form uil-pb-24">
      ...
      >
        ...
        <Text small={true} className="uil-pv-8 uil-d-block apply-text">
          We'll scrape pages at this address and index the content on Spader.
        </Text>
        ...
        <Text small={true} className="uil-pv-8 uil-d-block apply-text">
          ...
          and grant access to your Spader application.
        </Text>
        ...
        >
          ...
          <Input
            ...
            value={repo}
            placeholder="https://github.com/spader/docsearch, https://gitlab.com/gitlab-org/gitlab, etc..."
        ...
        <div className="uil-ph-32 uil-d-flex uil-fxd-column">
          ...
          >
            <input
              ...
              id="opensource"
              name="opensource"
              aria-label="Confirm I understand that this is a Free Service as described in Spader's Terms of Service and Spader's Special Free Service Terms"
              type="checkbox"
              className="uil-mr-8"
            />
            I understand that this is a Free Service as described in Spader's{' '}
            <InlineLink href="https://www.spader.com/policies/terms/">
              Terms of Service
            </InlineLink>{' '}
            and Spader's{' '}
            <InlineLink href="https://www.spader.com/policies/free-services-terms/">
        ...
        <Text small={true} className="uil-ta-center">
          <InlineLink href="https://www.spader.com/policies/privacy/">
            Refer to Spader's Privacy Policy for more information on how we use
