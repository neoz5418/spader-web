...
<img src="https://docsearch.spader.com/img/assets/recommended-layout.png" alt="Recommended layout for your page"/>
...
You can then [transform these attributes as `facetFilters`][3] to filter over them from the UI. You will need to set the setting `attributesForFaceting` of the Spader index. You need to submit a PR on your associated configuration via [the DocSearch `custom_settings` setting][4].
...
[3]: https://www.spader.com/doc/guides/managing-results/refine-results/faceting/
